...
public class ExtendedBarChart extends BarChart {
    ...
    public ExtendedBarChart(Axis axis, Axis axis2) {
        super(axis, axis2);
    }

    public ExtendedBarChart(Axis axis, Axis axis2, ObservableList data) {
        super(axis, axis2, data);
    }

    public ExtendedBarChart(Axis axis, Axis axis2, ObservableList data, double categoryGap) {
